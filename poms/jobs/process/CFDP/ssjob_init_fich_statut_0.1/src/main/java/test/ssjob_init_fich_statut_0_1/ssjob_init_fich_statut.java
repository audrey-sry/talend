...
package test.ssjob_init_fich_statut_0_1;
...
/**
 * Job: ssjob_init_fich_statut Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20190228_0243-patch
 * @status 
 */
public class ssjob_init_fich_statut implements TalendJob {
	static {System.setProperty("TalendJob.log", "ssjob_init_fich_statut.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ssjob_init_fich_statut.class);
...
public String getSsql_cfdp_Server(){
	...
	private final String jobName = "ssjob_init_fich_statut";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ssjob_init_fich_statut.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ssjob_init_fich_statut.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_TEST_ssjob_init_fich_statut = new byte[0];
    static byte[] commonByteArray_TEST_ssjob_init_fich_statut = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_TEST_ssjob_init_fich_statut.length) {
				if(length < 1024 && commonByteArray_TEST_ssjob_init_fich_statut.length == 0) {
   					commonByteArray_TEST_ssjob_init_fich_statut = new byte[1024];
				} else {
   					commonByteArray_TEST_ssjob_init_fich_statut = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_TEST_ssjob_init_fich_statut, 0, length);
			strReturn = new String(commonByteArray_TEST_ssjob_init_fich_statut, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_TEST_ssjob_init_fich_statut) {
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBRow_2{
                    ...
                    log4jParamters_tDBRow_2.append("Parameters:");
                        ...
                        log4jParamters_tDBRow_2.append(" | ");
                            log4jParamters_tDBRow_2.append("QUERY" + " = " + "\"insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('\" + out1.RST_CODE + \"', '\"+ out1.str_id + \"', '\"+ context.date +\"');\"");
                        log4jParamters_tDBRow_2.append(" | ");
...
if(out1 != null) { 
	...
	currentComponent="tDBRow_2";
			...
			//out1
	    		...
	    		log.debug("tDBRow_2 - Executing the query: '" + "insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('" + out1.RST_CODE + "', '"+ out1.str_id + "', '"+ context.date +"');" + "'.");
			
query_tDBRow_2 = "insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('" + out1.RST_CODE + "', '"+ out1.str_id + "', '"+ context.date +"');";
whetherReject_tDBRow_2 = false;
globalMap.put("tDBRow_2_QUERY",query_tDBRow_2);
try {
		stmt_tDBRow_2.execute(query_tDBRow_2);
		
	    		log.debug("tDBRow_2 - Execute the query: '" + "insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('" + out1.RST_CODE + "', '"+ out1.str_id + "', '"+ context.date +"');" + "' has finished.");
...
System.out.println("ERROR init statut");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// source node:tDBInput_2 - inputs:(after_tJavaFlex_1) outputs:(row2,row2) | target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_2{
                    ...
                    log4jParamters_tDBInput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"REFSTATUTTRAITEMENT\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("QUERY" + " = " + "\"select * from refstatuttraitement where description = '\" + context.statut + \"';\"");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_2.append(" | ");
                            log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("RST_CODE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DESCRIPTION")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("EST_STATUT_FINAL")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("ORDRE")+"}]");
                        log4jParamters_tDBInput_2.append(" | ");
		    ...
		    String dbquery_tDBInput_2 = "select * from refstatuttraitement where description = '" + context.statut + "';";
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.RST_CODE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
            ...
            if(rs_tDBInput_2.getObject(3) != null) {
                row2.EST_STATUT_FINAL = rs_tDBInput_2.getBoolean(3);
            } else {
                    row2.EST_STATUT_FINAL = null;
            }
		                    }
 ...
 */
    ...
    public static void main(String[] args){
        final ssjob_init_fich_statut ssjob_init_fich_statutClass = new ssjob_init_fich_statut();

        int exitCode = ssjob_init_fich_statutClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'ssjob_init_fich_statut' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'ssjob_init_fich_statut' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = ssjob_init_fich_statut.class.getClassLoader().getResourceAsStream("test/ssjob_init_fich_statut_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ssjob_init_fich_statut.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ssjob_init_fich_statut");
        }
...
/************************************************************************************************
 *     110690 characters generated by Talend Cloud Data Management Platform 
 *     on the September 13, 2019 3:26:00 PM CEST
 ************************************************************************************************/