package test.update_statut_0_1;
...
/**
 * Job: update_statut Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20190228_0243-patch
 * @status 
 */
public class update_statut implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "update_statut.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(update_statut.class);
	...
	private final String jobName = "update_statut";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					update_statut.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(update_statut.this, new Object[] { e,
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_update_statut = new byte[0];
		static byte[] commonByteArray_TEST_update_statut = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_update_statut.length) {
					if (length < 1024
							&& commonByteArray_TEST_update_statut.length == 0) {
						commonByteArray_TEST_update_statut = new byte[1024];
					} else {
						commonByteArray_TEST_update_statut = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_update_statut, 0, length);
				strReturn = new String(commonByteArray_TEST_update_statut, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_update_statut) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBRow_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBRow_2
									.append("QUERY"
											+ " = "
											+ "\"update historisationstatuttraitement set rst_code= '\" + out1.RST_CODE + \"' where str_id = \" + context.str_id + \";\"");
							log4jParamters_tDBRow_2.append(" | ");
				...
				if (tHash_Lookup_row2 != null
					...
					// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.DESCRIPTION = '"
					// + row2HashKey.DESCRIPTION + "'");
				} // G 071
				...
				if (out1 != null) {
					...
					log.debug("tDBRow_2 - Executing the query: '"
							+ "update historisationstatuttraitement set rst_code= '"
							+ out1.RST_CODE + "' where str_id = "
							+ context.str_id + ";" + "'.");

					query_tDBRow_2 = "update historisationstatuttraitement set rst_code= '"
							+ out1.RST_CODE
							+ "' where str_id = "
							+ context.str_id + ";";
				...
				if (out2 != null) {
					...
					if (out2.str_id != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(out2.str_id));
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2.append("QUERY" + " = "
									+ "\"select * from refstatuttraitement;\"");
							log4jParamters_tDBInput_2.append(" | ");
				...
				String dbquery_tDBInput_2 = "select * from refstatuttraitement;";
	...
	public static void main(String[] args) {
		final update_statut update_statutClass = new update_statut();

		int exitCode = update_statutClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'update_statut' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'update_statut' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = update_statut.class
					.getClassLoader().getResourceAsStream(
							"test/update_statut_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = update_statut.class
						.getClassLoader()
						.getResourceAsStream(
			...
			try {
				context.str_id = routines.system.ParserUtils
						.parseTo_Integer(context.getProperty("str_id"));
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : update_statut");
		}
...
/************************************************************************************************
 * 118658 characters generated by Talend Cloud Data Management Platform on the
 * September 11, 2019 5:19:23 PM CEST
 ************************************************************************************************/
