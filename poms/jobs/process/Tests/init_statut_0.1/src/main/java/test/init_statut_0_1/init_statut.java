...
/**
 * Job: init_statut Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20190228_0243-patch
 * @status 
 */
public class init_statut implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "init_statut.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(init_statut.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (rst_code != null) {
				...
				this.setProperty("rst_code", rst_code.toString());
		...
		public String nb_lignes;

		public String getNb_lignes() {
	...
	private final String jobName = "init_statut";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(init_statut.this, new Object[] { e,
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				context.rep_ftp = "aurevoir";

				context.date = TalendDate.formatDate("yyyy-MM-dd HH:mm:ss",
						TalendDate.getCurrentDate());

				context.statut = "PRIS_EN_CHARGE";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBRow_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBRow_1
									.append("QUERY"
											+ " = "
											+ "\"insert into SUIVITRAITEMENT (nom_fichier) VALUES ('\" + context.name + \"');\"");
							log4jParamters_tDBRow_1.append(" | ");
				...
				log.debug("tDBRow_1 - Executing the query: '"
						+ "insert into SUIVITRAITEMENT (nom_fichier) VALUES ('"
						+ context.name + "');" + "'.");

				query_tDBRow_1 = "insert into SUIVITRAITEMENT (nom_fichier) VALUES ('"
						+ context.name + "');";
	...
	public static class out1Struct implements
		...
		final static byte[] commonByteArrayLock_TEST_init_statut = new byte[0];
		static byte[] commonByteArray_TEST_init_statut = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_init_statut.length) {
					if (length < 1024
							&& commonByteArray_TEST_init_statut.length == 0) {
						commonByteArray_TEST_init_statut = new byte[1024];
					} else {
						commonByteArray_TEST_init_statut = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_init_statut, 0, length);
				strReturn = new String(commonByteArray_TEST_init_statut, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_init_statut) {
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBRow_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBRow_2.append("CONNECTION" + " = "
									+ "tDBConnection_1");
							log4jParamters_tDBRow_2.append(" | ");
							log4jParamters_tDBRow_2.append("IDENTITY_INSERT"
									+ " = " + "false");
							log4jParamters_tDBRow_2.append(" | ");
							...
							log4jParamters_tDBRow_2
									.append("QUERY"
											+ " = "
											+ "\"insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('\" + out1.RST_CODE + \"', '\"+ out1.str_id + \"', '\"+ context.date +\"');\"");
							log4jParamters_tDBRow_2.append(" | ");
							log4jParamters_tDBRow_2.append("DIE_ON_ERROR"
									+ " = " + "false");
							log4jParamters_tDBRow_2.append(" | ");
							log4jParamters_tDBRow_2
									.append("PROPAGATE_RECORD_SET" + " = "
							...
							log4jParamters_tDBRow_2
									.append("USE_PREPAREDSTATEMENT" + " = "
											+ "false");
							log4jParamters_tDBRow_2.append(" | ");
							log4jParamters_tDBRow_2.append("UNIFIED_COMPONENTS"
									+ " = " + "tMSSqlRow");
							log4jParamters_tDBRow_2.append(" | ");
							if (log.isDebugEnabled())
								log.debug("tDBRow_2 - "
				...
				if (conn_tDBRow_2 != null) {
					if (conn_tDBRow_2.getMetaData() != null) {
						...
						log.debug("tDBRow_2 - Uses an existing connection with username '"
								+ conn_tDBRow_2.getMetaData().getUserName()
								+ "'. Connection URL: "
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							row1.SCOPE_IDENTITY = null;
						} else {

							if (rs_tDBInput_1.getObject(1) != null) {
								row1.SCOPE_IDENTITY = rs_tDBInput_1.getInt(1);
							} else {
								row1.SCOPE_IDENTITY = null;
							}
						}
						...
						while ((tHash_Lookup_row2 != null && tHash_Lookup_row2
							...
							{ // start of Var scope
								...
								out1_tmp.str_id = row1.SCOPE_IDENTITY;
							...
							if (out1 != null) {
								...
								log.debug("tDBRow_2 - Executing the query: '"
										+ "insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('"
										+ out1.RST_CODE + "', '" + out1.str_id
										+ "', '" + context.date + "');" + "'.");

								query_tDBRow_2 = "insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('"
										+ out1.RST_CODE
										+ "', '"
										+ out1.str_id
										+ "', '" + context.date + "');";
								...
								try {
									...
									log.debug("tDBRow_2 - Execute the query: '"
											+ "insert into historisationstatuttraitement (rst_code, str_id, cree_le) values ('"
											+ out1.RST_CODE + "', '"
											+ out1.str_id + "', '"
											+ context.date + "');"
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBCommit_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBCommit_2.append("CONNECTION"
									+ " = " + "tDBConnection_1");
							log4jParamters_tDBCommit_2.append(" | ");
							log4jParamters_tDBCommit_2.append("CLOSE" + " = "
									+ "true");
							log4jParamters_tDBCommit_2.append(" | ");
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2
									.append("QUERY"
											+ " = "
											+ "\"select * from refstatuttraitement where description = '\" + context.statut + \"';\"");
							log4jParamters_tDBInput_2.append(" | ");
				...
				String dbquery_tDBInput_2 = "select * from refstatuttraitement where description = '"
						+ context.statut + "';";
	...
	public static void main(String[] args) {
		final init_statut init_statutClass = new init_statut();

		int exitCode = init_statutClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'init_statut' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'init_statut' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = init_statut.class.getClassLoader()
					.getResourceAsStream(
							"test/init_statut_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = init_statut.class
						.getClassLoader()
						.getResourceAsStream(
			...
			context.setContextType("rst_code", "id_String");

			context.rst_code = (String) context.getProperty("rst_code");
			context.setContextType("str_id", "id_String");

			context.str_id = (String) context.getProperty("str_id");
			...
			context.setContextType("nb_lignes", "id_String");

			context.nb_lignes = (String) context.getProperty("nb_lignes");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("rst_code")) {
				context.rst_code = (String) parentContextMap.get("rst_code");
			}
			if (parentContextMap.containsKey("str_id")) {
				context.str_id = (String) parentContextMap.get("str_id");
			}
			...
			if (parentContextMap.containsKey("nb_lignes")) {
				context.nb_lignes = (String) parentContextMap.get("nb_lignes");
			}
			if (parentContextMap.containsKey("non_conforme")) {
				context.non_conforme = (String) parentContextMap
						.get("non_conforme");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : init_statut");
		}
...
/************************************************************************************************
 * 126717 characters generated by Talend Cloud Data Management Platform on the
 * September 11, 2019 5:11:07 PM CEST
 ************************************************************************************************/
